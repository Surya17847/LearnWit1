...
userData[userEmail]['OS_level1'] = userData[userEmail]['OS_level1'] || {}; // Create 'subject' object if it doesn't exist
userData[userEmail]['OS_level1']['level1'] = userData[userEmail]['OS_level1']['level1'] || {}; // Create 'level' object if it doesn't exist
userData[userEmail]['OS_level1']['level1'].questions = userData[userEmail]['OS_level1']['level1'].questions || []; // Create 'questions' array if it doesn't exist
userData[userEmail]['OS_level1']['level1'].questions.push({
...
const displayResult = () => {
  ...
  quiz.innerHTML = `
    ...
    <div class="result">
      ...
      <a href="OS_l1_review.html" ><button>REVIEW</button></a>
