...
analyzeBtn.addEventListener("click", () => {
    ...
    const displayUserActivity = (userEmail) => {
        ...
        if (userData && userData[userEmail] && userData[userEmail]['AOA_level1'] && userData[userEmail]['AOA_level1']['level1'] && userData[userEmail]['AOA_level1']['level1'].questions && userData[userEmail]['AOA_level1']['level1'].questions.length > 0) {
            let totalCorrect = 0;
            let totalWrong = 0;

            userData[userEmail]['AOA_level1']['level1'].questions.forEach(q => {
