...
analyzeBtn.addEventListener("click", () => {
    const getUserActivity = (userEmail) => {
        ...
        const questions = userData[userEmail]?.['AOA_level3']?.['level3']?.questions || [];
        ...
        userData[userEmail]['AOA_level3']['level3'] = { questions: uniqueQuestionData }; // Update userData with unique questions
        return userData;
    };
    ...
    const displayUserActivity = (userEmail) => {
        ...
        if (userData && userData[userEmail] && userData[userEmail]['AOA_level3'] && userData[userEmail]['AOA_level3']['level3'] && userData[userEmail]['AOA_level3']['level3'].questions && userData[userEmail]['AOA_level3']['level3'].questions.length > 0) {
            let totalCorrect = 0;
            let totalWrong = 0;

            userData[userEmail]['AOA_level3']['level3'].questions.forEach(q => {
